...
const float OUTER_HOMING_BACKOFF_MM = 2.0f;
const float INNER_HOMING_BACKOFF_MM = 7.0f;
const float SWITCH_CLEAR_MM = 3.0f;
const float MAX_HOMING_TRAVEL_MM = 50.0f;

const long OUTER_BACKOFF_STEPS = (long)(OUTER_HOMING_BACKOFF_MM * OUTER_STEPS_PER_MM + 0.5f);
const long INNER_BACKOFF_STEPS = (long)(INNER_HOMING_BACKOFF_MM * INNER_STEPS_PER_MM + 0.5f);
